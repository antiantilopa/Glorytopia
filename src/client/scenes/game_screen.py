...
def init():
    ...
    def update(self: Client):
        ...
        while not self.changing_main_cycle:
            if self.updated == 0:
                continue
            if self.updated & (2 ** UpdateCodes.INIT_WORLD.value):
            ...
            if self.updated & (2 ** UpdateCodes.UPDATE_TILE.value):
            ...
            if self.updated & (2 ** UpdateCodes.UPDATE_UNIT.value):
            ...
            if self.updated & (2 ** UpdateCodes.UPDATE_CITY.value):
